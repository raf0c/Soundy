...
public class DialogAuthSC extends Dialog {
    ...
    private static final String TAG = "SoundCloud-WebView";


    public DialogAuthSC(Context context, String url, OAuthDialogListener listener) {
        super(context);
        mUrl = url;
        mListener = listener;
    }
